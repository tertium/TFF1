...
community. As part of the MPTP project \cite{urban-2006}, Urban designed
private extensions of the TPTP FOF syntax with dependent polymorphic types, and
translation from these, but there was no attempt to standardize these; we hope
that TFF2 will subsume this work. Also related to TFF1 is the full THF syntax
\cite{sutcliffe-benzmueller-2010}, which is not yet finalized or implemented in
any tool. Like Urban's extensions, full THF supports dependent types.
