...
do not appear in the quantifier-free matrix. Fortunately, this
can be done in an easy and lightweight manner.
...
\begin{theorem}[Soundness and completeness of $\ELI$] \label{thm:eli}
