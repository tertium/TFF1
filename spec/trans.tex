...
We describe a translation from TFF1 to the many-sorted first-order logic TFF0.%
\footnote{The TFF0 specification \cite{TFF0} prefers the term ``type'' to
``sort,'' but since only nullary type constructors are supported, TFF1 types are
