...
non-dependently typed TFF formulas according to the
following equations:
\begin{align*}
...
which is beyond the current scope of TFF. In order to submit such
...
on any less intrusive way to handle dependently typed TFF formulas.
