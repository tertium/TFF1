...
In this section, we describe a translation from TFF1 to the classical many-sorted
...
%%% @ANDREI: I found the footnote came too early: It refers to TFF0 but the
%%% footnote call was before TFF0! Also, by principle, I like to give the reader
%%% a chance to finish their sentence before moving to the footnote, unless the
%%% footnote is a sentence fragment.
...
respectively.%
\footnote{%
In fact, because the generated TFF0 problems are monotonic, the sorts can safely
be erased to obtain an equisatisfiable FOF problem \cite{claessen-et-al-2011}.
}
