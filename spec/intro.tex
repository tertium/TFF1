...
the SMT (satisfiability modulo theories) solver Alt-Ergo
...
\cheat
\item Section~\ref{sec_related} considers related work in the TPTP and SMT
communities:\ polymorphic formalisms and translation schemes to untyped or
monomorphic logics.
\end{itemize}
